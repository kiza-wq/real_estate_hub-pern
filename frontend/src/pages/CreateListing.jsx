        ...
        >
          ...
          <div className="flex flex-col flex-1 gap-4">
              ...
              formData.image_urls.map((url, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="border border-red-600/70 hover:bg-red-600/10 text-red-600 font-semibold px-4 py-2 rounded-lg cursor-pointer m-1 hover:shadow-lg disabled:opacity-80"
                  >
                    Delete
                  </button>
                </div>
            ...
            <button
              ...
              className=" bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition font-medium disabled:opacity-80 text-center"
            >
